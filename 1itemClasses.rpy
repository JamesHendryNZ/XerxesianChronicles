...
define metalArrow = Item( "Metal Arrow" , "images/items/arrowBoltShort.webp" , "ammo" , 0 , 0 , "Shoot" , 20 , "A heavy metal arrow for punching through armor." , 12 ) #for armored foes mid game
...
define bluePotion = Item("Healing Potion (Blue)" , "images/items/bottlePotionBlue.webp" , "potion" , 80 , 4 , "Heals" , 0 , "Magic potion that replenisihes a lot of lifeforce to keep auto-heal going. Heals 80 for 4 turns" , 100)
...
define smellyCheese = Item( "Smelly Cheese" , "images/items/smeally cheese.webp" , "reviver" , 25 , 4 , "Revives" , 0 , "A cheesy food so skinky it can revive people and heal them 25 hitpoints for 4 turns." , 100  )
...
define spicycrayfish = Item( "Spicy Crayfish" , "images/items/cave crayfish cooked spicy.webp" ,"potion" , 30 , 2 , "BoostedAttack" , 0 , "Spicy crayfish is very tasty. Heals 30 and gives you a breif boost in attack." , 40 )
define cookedfish = Item( "Cooked Fish" , "images/items/jamesosian flood fish cooked.webp" , "potion" , 40 , 4 , "Heals" , 0 , "Yummy yummy cooked fried fish. Heals 40 per turn for 2 turns.", 40) 
define redSpice = Item("Red Spice" , "images/items/red spice.webp" , "chemical" , 0 , 0 , "chemical" , 0 , "Can make food spicy" , 10 )
define spicycookedfish = Item( "Spicy Fish" , "images/items/jamesosian flood fish cooked Spicy.webp" , "BoostedAttack" , 30 , 2 , "Heals" , 0 , "Yummy yummy spciy fried fish. Heals 50 and gives you a breif boost in attack.", 40 )
define cookedMeat = Item("Cooked Meat" , "images/items/Cooked Meat.webp" , "potion" , 25 , 3 , "Heals" , 0 , "Fried Monsters and other animals, much better than raw. Heals 25 per turn from 3 turns." , 5 )
...
define reviverFang = Item( "Reviver Fang" , "images/items/reviver fang.webp" , "reviver" , 420 , 0 , "Revives" , 0 , "A quick large snake fang that gives life insted of taking it away." , 100 )  
...
define foodLeevz = Item( "Edible Leaves" , "images/items/food Leaves.webp" , "potion" , 7 , 8 , "Heals" , 0 , "Leaves that can be eaten. Takes awhile munch and digest. Heals 7 for 8 turns." , 6 )
...
define ribbz = Item( "Meat Ribbs" , "images/items/Meat Ribs.webp" , "potion" , 45 , 4 , "Heals" , 0 , "MEAT RIBS!!! Delicious juicy meat with a crunchable bone inside. Heals 45 for 3 turns" , 20 )
